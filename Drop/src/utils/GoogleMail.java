...
public class GoogleMail {
    ...
    private final String username = "droppointepsilon";
    private final String password = "cdioil2015";
     ...
     * connected state or if the message is not a MimeMessage
     */
    public void send(String username, String password, String recipientEmail, String ccEmail, String title, String message) throws AddressException, MessagingException {
