...
BEGIN
  ...
  exception
    when others then
      raise_application_error(-20001, 'Nao foi poss�vel atualizar o estado da prateleira');
  end;
...
BEGIN
  ...
  exception
    when others then
      raise_application_error(-20001, 'N�o foi poss�vel atualizar o estado da prateleira');
  end;
...
-- TRIGGER PARA MUDAR A PRATELEIRA para inoperacional CONSOANTE a inser��o de um incidente 
-- PELA EQUIPA DE MANUTENCAO
...
BEGIN
  ...
  exception
    when others then
      raise_application_error(-20004, 'N�o foi poss�vel atualizar o estado da prateleira');
  end;
...
INSERT INTO DropPoint (ID_DROPPOINT,ID_MORADA,ID_GESTOR,NOME_DROPPOINT,FREE_DAYS) VALUES (2, 7, 2,'DP Esta��o CP S�o Bento',0);
INSERT INTO DropPoint (ID_DROPPOINT,ID_MORADA,ID_GESTOR,NOME_DROPPOINT,FREE_DAYS) VALUES (3, 8, 3,'DP Esta��o Metro Trindade',0);
INSERT INTO DropPoint (ID_DROPPOINT,ID_MORADA,ID_GESTOR,NOME_DROPPOINT,FREE_DAYS) VALUES (4, 9, 4,'DP Campus S. Jo�o',0);
...
INSERT INTO Token (ID_TOKEN,DATA_GERACAO,DATA_VALIDADE,ID_TIPO_TOKEN,ID_RESERVA,CODIGO,ATIVO) 
  ...
  INSERT INTO Token (ID_TOKEN,DATA_GERACAO,DATA_VALIDADE,ID_TIPO_TOKEN,ID_RESERVA,CODIGO,ATIVO) 
  VALUES (13,TO_DATE('20-10-2015 17:00', 'dd-mm-yyyy HH24:MI'),TO_DATE('27-10-2015 17:00', 'dd-mm-yyyy HH24:MI'),3,null,'3pW45xf7Q',1);
