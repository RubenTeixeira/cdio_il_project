...
INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (2, 'Rua Jaime Lopes Amorim',20, '4465-004', 'S. Mamede de Infesta','41.1898662','-8.6015942');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (3, 'Rua Roberto Frias',602, '4200-465', 'Porto','41.1801581','-8.597438');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (4, 'Rua Valente Perfeito',322, '4400-330', 'Vila Nova de Gaia','41.1330481','-8.6228943');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (5, 'Rua da Alegria',503, '4000-045','Porto','41.1544937','-8.6053933');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (6, 'Rua Sara Afonso',105, '4460-841', 'Senhora da Hora','41.1807708','-8.6567255');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (7, 'Pra¡a de Almeida Garrett',46, '4000-069', 'Porto','41.1455754','-8.6106484');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (8, 'Rua de Camões',19, '4000-124', 'Porto','41.1524433','-8.6096905');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (9, 'Rua DR. Plácido da Costa',40, '4200-450', 'Porto','41.1804142','-8.6063489');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (10, 'Rua Serpa Pinto',12, '4820-450', 'Fafe','41.451496','-8.172281');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (11, 'Av. Dom João II',124, '1560-330', 'Lisboa','38.7684236','-9.0986667');

INSERT INTO Morada (ID_MORADA,RUA,NUMERO,CODPOSTAL,LOCALIDADE,LATITUDE,LONGITUDE) 
  VALUES (12, 'Rua da Moegem',546, '1560-330', 'Faro','37.0195556','-7.9408538');
...
INSERT INTO DropPoint (ID_DROPPOINT,ID_MORADA,ID_GESTOR,NOME_DROPPOINT,FREE_DAYS,MAX_RATE) VALUES (5, 10, 4,'DP Fafe',0,0.9);
INSERT INTO DropPoint (ID_DROPPOINT,ID_MORADA,ID_GESTOR,NOME_DROPPOINT,FREE_DAYS,MAX_RATE) VALUES (6, 11, 4,'DP Oriente',0,0.9);
INSERT INTO DropPoint (ID_DROPPOINT,ID_MORADA,ID_GESTOR,NOME_DROPPOINT,FREE_DAYS,MAX_RATE) VALUES (7, 12, 4,'DP Estação Faro',0,0.9);
